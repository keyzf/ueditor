...
( function () {
    ...
    $.extend( AutoComplete.prototype, {
        ...
        _getItemHtml: function ( searchText, items ) {
            ...
            return '<ul><li class="search-result-item-wrap">'+ htmlStr.join( '</li><li class="search-result-item-wrap">' ) +'</li></ul>';
    ...
    $.extend( Panel.prototype, {
        ...
        change: function ( itemIndex ) {
            var $items = this._panel.find( ".search-result-item-wrap" ).css( "background", "" );
